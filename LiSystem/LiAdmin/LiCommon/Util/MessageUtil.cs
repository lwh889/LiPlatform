...
namespace LiCommon.Util
{
    ...
    public class MessageUtil
    {
        ...
        {
            return XtraMessageBox.Show(text, caption, buttons, MessageBoxIcon.Information);
        }


        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons)
        {
            return XtraMessageBox.Show(owner, text, caption, buttons, MessageBoxIcon.Information);
        }
        ...
        {
            return XtraMessageBox.Show(message, " 消息", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        {
            return XtraMessageBox.Show(message, caption, buttons, MessageBoxIcon.Information);
        }
        ...
        {
            return XtraMessageBox.Show(message, caption, buttons, MessageBoxIcon.Information, defButton);
        }
        #endregion
        ...
        {
            return XtraMessageBox.Show(text, "疑问", MessageBoxButtons.OK, MessageBoxIcon.Question);
        }
        public static DialogResult Question(string text, string caption)
        {
            return XtraMessageBox.Show(text, caption, MessageBoxButtons.OK, MessageBoxIcon.Question);
        }
        public static DialogResult Question(string text, string caption, MessageBoxButtons buttons)
        {
            return XtraMessageBox.Show(text, caption, buttons, MessageBoxIcon.Question);
        }
        ...
        {
            return XtraMessageBox.Show(text, caption, buttons, MessageBoxIcon.Question, defButton);
        }
        ...
        {
            return XtraMessageBox.Show(text, "警告", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        ...
        {
            return XtraMessageBox.Show(text, caption, buttons, MessageBoxIcon.Warning);
        }
        #endregion
        ...
        {
            return XtraMessageBox.Show(text, caption, buttons, MessageBoxIcon.Error);
        }
        #endregion
