...
insert into TableInfo (id,dataBaseName,entityType,entityKey,entityOrder,entityColumnName,tableName,tableAliasName,tableAbbName,tableDesc,className, keyName, childTableEntityColumnName,modifyDate) 
select 64,'LiSystem','Basic','liReport','slave','buttons','LiReportButton','liReportButton','报表按钮', null,'JsonModel','id','events',getdate()
insert into TableInfo (id,dataBaseName,entityType,entityKey,entityOrder,entityColumnName,tableName,tableAliasName,tableAbbName,tableDesc,className, keyName, childTableEntityColumnName,modifyDate) 
...
union all
select 23, 'iColumnIndex','列宽', 'int',9,0,0,0,0,null,0,null
union all
...
union all
select 62, 'bColumnGroup','是否启用列组', 'bit',1,0,0,0,0,null,0,null
union all
select 62, 'systemCode','系统帐套号', 'narchar',10,0,0,0,0,null,0,null
union all
select 62, 'menuCode','系统菜单编码', 'narchar',10,0,0,0,0,null,0,null
union all
select 62, 'dataBaseName','系统数据库', 'narchar',30,0,0,0,0,null,0,null
union all
...
union all
select 63, 'bOrderBy','是否排序', 'bit',1,0,0,0,0,null,0,null
union all
select 63, 'orderBy','排序升降', 'narchar',30,0,0,0,0,null,0,null
union all
select 63, 'iOrderByIndex','排序顺序', 'int',9,0,0,0,0,null,0,null
union all
...
union all
select 63, 'controlType','控件类型', 'narchar',30,0,0,0,0,null,0,null
union all
select 63, 'basicInfoKey','引用档案Key', 'narchar',30,0,0,0,0,null,0,null
union all
select 63, 'basicInfoShowFieldName','引用档案显示名称', 'narchar',50,0,0,0,0,null,0,null
union all
select 63, 'basicInfoShowMode','引用档案显示模式', 'narchar',30,0,0,0,0,null,0,null
union all
select 63, 'basicInfoTableKey','引用档案显示主键', 'narchar',50,0,0,0,0,null,0,null
union all
select 63, 'dictInfoType','字典档案Key', 'narchar',30,0,0,0,0,null,0,null
union all
select 63, 'gridlookUpEditShowModelJson','引用档案配置信息', 'narchar',30,0,0,0,0,null,0,null
